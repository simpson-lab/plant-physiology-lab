...
knitr::include_graphics(here("images", "rstudio-cloud-screen-upload-dialog-filled-added-n.png"))
```
...
knitr::include_graphics(here("images", "rstudio-cloud-screen-upload-complete-added-n.png"))
```
