...
knitr::include_graphics(here("images", "rstudio-cloud-new-project-annotated.png"))
```
...
knitr::include_graphics(here("images", "rstudio-cloud-change-project-name-annotated.png"))
```
...
knitr::include_graphics(here("images", "rstudio-cloud-new-script.png"))
```
...
knitr::include_graphics(here("images", "rstudio-cloud-screen-annotated.png"))
```
...
knitr::include_graphics(here("images", "rstudio-cloud-screen-upload-button.png"))
```
...
knitr::include_graphics(here("images", "rstudio-cloud-screen-upload-dialog.png"))
```
...
knitr::include_graphics(here("images", "rstudio-cloud-screen-upload-dialog-filled.png"))
```
...
knitr::include_graphics(here("images", "rstudio-cloud-screen-upload-complete.png"))
```
...
knitr::include_graphics(here("images", "rstudio-cloud-screen-save-script.png"))
```
...
knitr::include_graphics(here("images", "rstudio-cloud-screen-save-script-dialog.png"))
```
...
wt <- read_excel(here('data', 'f18ph.xls'), sheet = 1, col_types = col_types)
```
...
knitr::include_graphics(here("images", "original-dfs-tidy.png"))
```
...
knitr::include_graphics(here("images", "tidyr-longer-wider.gif"))
```
...
5. `names_transform = list(day = as.integer)` --- we want the created `day` column to contain integer values not text
...
dwarf <- read_excel(here('data', 'f18ph.xls'), sheet = 4, col_types = col_types)
dwarf <- pivot_longer(dwarf, -(1:3), names_sep = ':',
                      names_to = c('variable','day'),
                      names_transform = list(day = as.integer))
dwarf <- pivot_wider(dwarf, names_from = variable, values_from = value)
...
Now that we have the data as we'd like it, we need to stick the two objects together, which we do with `bind_rows()`
...
The number of internodes data is similar to the plant height data; the number of internodes was recorded every 7 days during the period of the experiment. Therefore, an ANCOVA is an appropriate way to analyse the internode data.

To analyse the inernode data, you can follow the instructions given for plant height, but use the `internodes` variable in place of `height`.

**You are required to include an analysis of the number of internodes data in your assignment for the lab.** 
...
knitr::include_graphics(here("images", "rstudio-cloud-screen-export-button.png"))
```

From the menu that appears choose **Save as Image...**

```{r show-studio-cloud-export-2, echo=FALSE, out.width="750px"}
knitr::include_graphics(here("images", "rstudio-cloud-screen-export-image.png"))
```
...
knitr::include_graphics(here("images", "rstudio-cloud-screen-export-image-dialog.png"))
```
...
knitr::include_graphics(here("images", "rstudio-cloud-screen-export-files.png"))
```
...
knitr::include_graphics(here("images", "rstudio-cloud-screen-export-files-dialog.png"))
```
...
knitr::include_graphics(here("images", "rstudio-cloud-screen-logout-1.png"))
```

Click your user name to open the menu

```{r show-studio-cloud-logout-2, echo=FALSE, out.width="500px"}
knitr::include_graphics(here("images", "rstudio-cloud-screen-logout-2.png"))
```
